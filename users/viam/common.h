...
#if defined(QMK_MCU_RP2040) && defined(COMBO_ENABLE)
    #if (!defined(PLOOPY_COBMO_EXCESSIVE))
        #define PLOOPY_COBMO_EXCESSIVE
    #endif // PLOOPY_COBMO_EXCESSIVE
#endif // QMK_MCU_RP2040

#if defined(COMMUNITY_MODULE_POINTING_DEVICE_ACCEL_ENABLE) && defined(CONSOLE_ENABLE)
    #if defined(PRINTF_SUPPORT_DECIMAL_SPECIFIERS)
        #undef PRINTF_SUPPORT_DECIMAL_SPECIFIERS
        #define PRINTF_SUPPORT_DECIMAL_SPECIFIERS 1
    #endif // PRINTF_SUPPORT_DECIMAL_SPECIFIERS
#endif // defined(COMMUNITY_MODULE_POINTING_DEVICE_ACCEL_ENABLE) && defined(CONSOLE_ENABLE)
