...
#if (defined(COMMUNITY_MODULE_POINTING_DEVICE_ACCEL_ENABLE)||defined(COMMUNITY_MODULE_BASIC_POINTING_ACCELERATION_ENABLE)) && defined(CONSOLE_ENABLE)
...
#if defined(QMK_MCU_RP2040) && defined(COMMUNITY_MODULE_TASK_SWITCH_ENABLE)
    #define TASK_SWITCH_MENUS_ENABLE
